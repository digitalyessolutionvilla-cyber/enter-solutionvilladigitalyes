      ...
      <section className="relative pt-28 pb-20 overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[rgba(212,175,55,0.25)] bg-[rgba(212,175,55,0.06)] mb-6">
            ...
            <span className="text-[#D4AF37] text-xs font-semibold tracking-wider uppercase">What We Do</span>
          </div>

          <h1 className="font-display font-bold text-5xl md:text-6xl lg:text-7xl text-white leading-[1.05] mb-6">
            Premium Solutions<br />
            <span className="gradient-text-static">For Every Challenge</span>
          </h1>
          <p className="text-white/50 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed mb-10">
            From brand identity to enterprise software — we deliver world-class digital
            solutions that drive measurable growth for ambitious businesses across Africa and beyond.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[rgba(212,175,55,0.2)] bg-[rgba(212,175,55,0.05)] mb-6">
                <span className="text-[#D4AF37] text-xs font-semibold tracking-wider uppercase">The Digital YES</span>
              </div>
              <h2 className="font-display font-bold text-4xl md:text-5xl text-white leading-tight mb-6">
                We Say <span className="gradient-text-static">YES</span> to Every<br />Digital Challenge
              </h2>
              <p className="text-white/50 text-base leading-relaxed mb-8">
                At Solution Villa, no project is too big or too complex. Since 2016, we've built our
                reputation by delivering premium results for every client — from startups to
                established enterprises across Africa and beyond.
              </p>
          ...
          <div className="relative rounded-3xl overflow-hidden border border-[rgba(212,175,55,0.2)] p-12 md:p-16 text-center"
            ...
            <div className="relative z-10">
              <h2 className="font-display font-bold text-4xl md:text-5xl text-white mb-4">
                Ready to Start Your<br /><span className="gradient-text-static">Next Project?</span>
              </h2>
              <p className="text-white/45 text-lg max-w-xl mx-auto mb-10">
                Tell us about your vision — we'll build the perfect solution. No challenge is too big, no dream too ambitious.
              </p>
